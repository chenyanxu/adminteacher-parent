 ...
 * @author chenyanxu
 */
Ext.define('kalix.adminteacher.teacher.controller.UserWindowController', {
    extend: 'kalix.controller.BaseWindowController',
    alias: 'controller.teacherUserWindowController',
    ...
    blur: function (target, event, eOpts) {
        ...
        var rest_url = CONFIG.restRoot + '/camel/rest/teachers/loginname/' + lv;
        Ext.Ajax.request({
            url: rest_url,
