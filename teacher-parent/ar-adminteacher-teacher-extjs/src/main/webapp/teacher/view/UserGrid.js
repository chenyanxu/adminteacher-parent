 ...
 * @version 1.0.0
 */
Ext.define('kalix.adminteacher.teacher.view.UserGrid', {
  extend: 'kalix.view.components.common.BaseGrid',
  requires: [
    'kalix.adminteacher.teacher.controller.UserGridController',
  ...
  alias: 'widget.teacherUserGrid',
  xtype: 'teacherUserGridPanel',
  controller: {
    type: 'teacherUserGridController',
    cfgForm: 'kalix.adminteacher.teacher.view.UserWindow',
    cfgViewForm: 'kalix.adminteacher.teacher.view.UserViewWindow',
    cfgModel: 'kalix.adminteacher.teacher.model.UserModel'
  },
  store: {
